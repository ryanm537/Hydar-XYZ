...
#			i = 1
	...
	#inputFeatures = cfunc.array(inputFeatures)
	#inputComplement = cfunc.intarray(inputComplement)
	
	#print(features)
	classification = cfunc.classify(inputFeatures, features)
	if classification == 0:
		return "sentence"
	return "question"
